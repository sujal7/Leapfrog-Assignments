 ...
 */
function initializeGraphVariables(SIMULATION_TIME, population) {
...
function drawGraph() {
  ...
  // Draws reference value for population
  ...
  // Draws reference value for days with a step size of 5.
  context.font = 'bold 16px Arial';
